...
import { DollarSign, Clock, Check, X, ArrowRightLeft, CreditCard } from "lucide-react";
...
export default function OfferCard({
  ...
  return (
    <div className={`rounded-xl border p-4 space-y-3 ${statusColors[status] || statusColors.pending}`}>
      {/* Header */}
      ...
      <div className="text-center py-2">
        ...
        {status === "pending" && timeLeft && (
          <div className="flex items-center justify-center gap-1 mt-1.5">
            ...
            <span className="text-[10px] text-muted/60">{t("expiresIn", { time: timeLeft })}</span>
          </div>
        )}
      </div>
