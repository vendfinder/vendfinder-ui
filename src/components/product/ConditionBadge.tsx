...
export type ConditionValue = "new" | "used_like_new" | "used_good" | "used_fair";
...
export const CONDITIONS: ConditionConfig[] = [
  {
    value: "new",
    label: "New / Deadstock",
    description: "Brand new, unworn, with all original packaging and accessories",
    icon: Sparkles,
  ...
  },
  {
    ...
    description: "Worn 1-2 times with minimal signs of wear, complete packaging",
    icon: ShieldCheck,
    color: "text-blue-400",
  ...
  },
  {
    value: "used_good",
    label: "Used - Good",
    description: "Light wear visible, fully functional, may not include original packaging",
    icon: CheckCircle2,
