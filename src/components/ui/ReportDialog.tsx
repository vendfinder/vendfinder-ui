          ...
          {success ? (
            <div className="flex flex-col items-center gap-3 py-6">
              ...
              <p className="text-[12px] text-muted text-center">
                Thanks for helping keep VendFinder safe. We&apos;ll review your
            ...
            <>
              <p className="text-[12px] text-muted mb-4">
                Tell us what&apos;s wrong with this {targetType}:
              </p>
              ...
              <div className="space-y-2 mb-4">
                {REASONS.map((r) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-[13px] ${reason === r.id ? 'text-foreground font-medium' : 'text-muted'}`}
                    >
                      {r.label}
                    </span>
                  </label>
