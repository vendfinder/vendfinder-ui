...
export const products: Product[] = [
  // Sneakers
  {
    ...
    description: "The iconic AJ4 in the classic Bred colorway. Premium leather upper with visible Air unit.",
    ...
    stockCount: 12,
    sku: "SNK-AJ4-BRD",
    features: ["Premium nubuck leather upper", "Visible Air-Sole unit", "Mesh side panels", "Rubber outsole with herringbone pattern"],
    specifications: { Brand: "Nike", Style: "Air Jordan 4 Retro", Color: "Black/Cement Grey/Fire Red", Release: "2024" },
  ...
  },
  {
    ...
    description: "Clean black and white colorway that goes with everything. A modern classic.",
    ...
    stockCount: 25,
    sku: "SNK-DNK-PND",
    features: ["Leather upper", "Padded collar", "Rubber cupsole", "Perforated toe box"],
    specifications: { Brand: "Nike", Style: "Dunk Low", Color: "Black/White", Release: "2024" },
  ...
  },
  {
    ...
    description: "Retro basketball silhouette with a clean white and green colorway.",
    longDescription: "The New Balance 550 revives a classic 1989 basketball design with modern styling. This White/Green colorway features a premium leather upper with perforated detailing, a flat rubber outsole, and the signature N logo in forest green. A versatile sneaker that bridges the gap between sport and style.",
    price: 130,
    ...
    stockCount: 18,
    sku: "SNK-NB550-WG",
    features: ["Premium leather upper", "Flat rubber outsole", "Perforated side panels", "Padded tongue and collar"],
    specifications: { Brand: "New Balance", Style: "550", Color: "White/Green", Release: "2024" },
  ...
  },
  {
    ...
    description: "Minimalist EVA foam slide in sleek Onyx black. Ultimate comfort.",
    longDescription: "The Adidas Yeezy Slide in Onyx delivers a minimalist aesthetic with maximum comfort. Crafted from lightweight injected EVA foam, these slides feature a soft footbed and a serrated outsole for traction. The monochrome black colorway makes them a versatile choice for casual wear.",
    price: 70,
    compareAtPrice: 90,
    ...
    stockCount: 40,
    sku: "SNK-YZY-SLD",
    features: ["Injected EVA foam construction", "Soft footbed", "Serrated outsole", "Lightweight design"],
    specifications: { Brand: "Adidas", Style: "Yeezy Slide", Color: "Onyx", Release: "2024" },
  ...
  },
  {
    ...
    description: "The OG Air Max 90 in the iconic Infrared colorway. Timeless design.",
    ...
    stockCount: 8,
    sku: "SNK-AM90-INF",
    features: ["Mixed material upper", "Visible Max Air unit", "Rubber waffle outsole", "Padded collar"],
    specifications: { Brand: "Nike", Style: "Air Max 90", Color: "White/Black/Infrared", Release: "2024" },
    sizes: ["7", "7.5", "8", "8.5", "9", "9.5", "10", "10.5", "11", "11.5", "12", "13"],
  ...
  // Electronics
  {
    ...
    stockCount: 15,
    sku: "ELC-SNY-XM5",
    features: ["Industry-leading noise cancellation", "30-hour battery life", "LDAC Hi-Res Audio", "Multipoint connection"],
    specifications: { Brand: "Sony", Type: "Over-ear wireless", Driver: "30mm", Weight: "250g" },
  ...
  },
  {
    ...
    description: "Active noise cancellation, spatial audio, and USB-C charging case.",
    ...
    stockCount: 30,
    sku: "ELC-APL-APP2",
    features: ["Active Noise Cancellation", "Adaptive Transparency", "Personalized Spatial Audio", "USB-C MagSafe case"],
    specifications: { Brand: "Apple", Type: "In-ear wireless", Chip: "H2", "Battery Life": "6 hours" },
  ...
  },
  {
    ...
    stockCount: 7,
    sku: "ELC-SAM-TS9",
    features: ["11\" Dynamic AMOLED 2X display", "S Pen included", "IP68 water resistant", "Snapdragon 8 Gen 2"],
    specifications: { Brand: "Samsung", Display: "11\" AMOLED", Processor: "Snapdragon 8 Gen 2", Storage: "128GB" },
  ...
  },
  {
    ...
    description: "Portable Bluetooth speaker with powerful bass and 20-hour battery.",
    ...
    stockCount: 22,
    sku: "ELC-JBL-CH5",
    features: ["JBL Original Pro Sound", "IP67 waterproof", "20-hour battery", "Built-in powerbank"],
    specifications: { Brand: "JBL", Type: "Portable speaker", Connectivity: "Bluetooth 5.1", Weight: "960g" },
  ...
  },
  {
    ...
    description: "Mixed reality headset with breakthrough graphics and immersive experiences.",
    ...
    stockCount: 10,
    sku: "ELC-MTA-QS3",
    features: ["Snapdragon XR2 Gen 2", "4K+ Infinite Display", "Full-color mixed reality", "No PC required"],
    specifications: { Brand: "Meta", Type: "VR Headset", Processor: "Snapdragon XR2 Gen 2", Storage: "128GB" },
  ...
  // Apparel
  {
    ...
    description: "Oversized fleece hoodie with signature Essentials branding. Ultra cozy.",
    ...
    stockCount: 15,
    sku: "STW-FOG-HDY",
    features: ["Heavyweight fleece cotton", "Oversized relaxed fit", "Rubber logo detail", "Kangaroo pocket"],
    specifications: { Brand: "Fear of God Essentials", Material: "100% Cotton", Fit: "Oversized", Care: "Machine wash cold" },
  ...
  },
  {
    ...
    description: "Slim-fit joggers in Nike's signature Tech Fleece fabric. Warm without bulk.",
    ...
    stockCount: 20,
    sku: "STW-NKE-TFJ",
    features: ["Nike Tech Fleece fabric", "Zippered pockets", "Tapered slim fit", "Ribbed cuffs"],
    specifications: { Brand: "Nike", Material: "Tech Fleece", Fit: "Slim tapered", Care: "Machine wash" },
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    description: "The iconic Supreme box logo on premium cotton. A streetwear grail.",
    longDescription: "The Supreme Box Logo Tee is one of the most recognizable pieces in streetwear culture. This season's release features the classic box logo printed on a heavyweight 100% cotton tee. The relaxed fit and reinforced collar ensure durability and comfort. A must-have for any streetwear collection.",
    price: 68,
    ...
    stockCount: 5,
    sku: "STW-SPR-BOG",
    features: ["Heavyweight cotton", "Box logo print", "Reinforced collar", "Relaxed fit"],
    specifications: { Brand: "Supreme", Material: "100% Cotton", Fit: "Relaxed", Care: "Machine wash cold" },
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    stockCount: 14,
    sku: "STW-STY-8BL",
    features: ["Midweight fleece", "Iconic 8-ball graphic", "Kangaroo pocket", "Ribbed cuffs and hem"],
    specifications: { Brand: "Stussy", Material: "80% Cotton / 20% Polyester", Fit: "Standard", Care: "Machine wash" },
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    description: "Rugged organic cotton canvas jacket with blanket-lined interior.",
    ...
    stockCount: 6,
    sku: "STW-CRT-DET",
    features: ["Organic cotton canvas", "Blanket-lined interior", "Corduroy collar", "Double chest pockets"],
    specifications: { Brand: "Carhartt WIP", Material: "Organic cotton canvas", Fit: "Relaxed", Care: "Machine wash cold" },
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  // Home & Living
  {
    ...
    description: "Smart mug that keeps your drink at the perfect temperature for hours.",
    ...
    stockCount: 20,
    sku: "HML-EMB-MG2",
    features: ["Temperature control technology", "1.5-hour battery life", "App controlled", "Charging coaster included"],
    specifications: { Brand: "Ember", Capacity: "10 oz", Material: "Stainless steel", Connectivity: "Bluetooth" },
  ...
  },
  {
    ...
    description: "Smart LED light bulbs with bridge. 16 million colors at your fingertips.",
    longDescription: "Transform your home lighting with the Philips Hue Starter Kit. Includes three A19 smart LED bulbs and the Hue Bridge for whole-home control. Choose from 16 million colors and shades of white to set the perfect mood. Works with Alexa, Google Home, and Apple HomeKit for seamless voice control.",
    price: 135,
    compareAtPrice: 170,
    ...
    stockCount: 12,
    sku: "HML-PHI-HUE",
    features: ["16 million colors", "Voice assistant compatible", "Schedule automations", "Hue Bridge included"],
    specifications: { Brand: "Philips Hue", Type: "LED Smart Bulbs", Count: "3 bulbs + bridge", Connectivity: "Zigbee + Bluetooth" },
  ...
  },
  {
    ...
    stockCount: 5,
    sku: "HML-DYS-V15",
    features: ["Laser dust detection", "Piezo sensor auto-adjust", "60-min battery life", "HEPA filtration"],
    specifications: { Brand: "Dyson", Type: "Cordless vacuum", "Run Time": "Up to 60 min", Weight: "6.8 lbs" },
  ...
  },
  {
    ...
    description: "Iconic enameled cast iron Dutch oven. A kitchen essential for generations.",
    ...
    stockCount: 8,
    sku: "HML-LCR-DO5",
    features: ["Enameled cast iron", "Superior heat distribution", "Oven safe to 500°F", "Lifetime warranty"],
    specifications: { Brand: "Le Creuset", Capacity: "5.5 Qt", Material: "Enameled cast iron", Color: "Flame Orange" },
  ...
  },
  {
    ...
    description: "Compact smart speaker with rich sound and built-in voice control.",
    ...
    stockCount: 16,
    sku: "HML-SNS-ONE",
    features: ["Rich room-filling sound", "Built-in voice assistants", "AirPlay 2 compatible", "Multi-room capable"],
    specifications: { Brand: "Sonos", Type: "Smart speaker", Connectivity: "Wi-Fi, AirPlay 2", Weight: "4.4 lbs" },
  ...
  // Accessories
  {
    ...
    longDescription: "The Casio G-Shock GA-2100 — nicknamed 'CasiOak' for its resemblance to the iconic AP Royal Oak — features an ultra-slim carbon core guard structure. The octagonal bezel, double LED light, and shock-resistant design make it both stylish and rugged. Water-resistant to 200 meters with a 3-year battery life.",
    price: 99,
    ...
    stockCount: 25,
    sku: "ACC-CSO-2100",
    features: ["Carbon core guard", "Shock resistant", "200m water resistant", "3-year battery"],
    specifications: { Brand: "Casio", Type: "G-Shock GA-2100", Movement: "Quartz", "Water Resistance": "200m" },
  ...
  },
  {
    ...
    description: "The world's most iconic sunglasses. Timeless style since 1952.",
    ...
    stockCount: 30,
    sku: "ACC-RBN-WAY",
    features: ["Crystal green G-15 lenses", "100% UV protection", "Acetate frame", "Metal hinges"],
    specifications: { Brand: "Ray-Ban", Model: "RB2140 Wayfarer", Lens: "Crystal Green G-15", Material: "Acetate" },
  ...
  },
  {
    ...
    description: "Classic backpack with laptop sleeve and signature striped lining.",
    ...
    stockCount: 18,
    sku: "ACC-HRS-RET",
    features: ["15\" laptop sleeve", "EcoSystem recycled fabric", "Magnetic strap closures", "Striped fabric liner"],
    specifications: { Brand: "Herschel", Type: "Backpack", Volume: "19.5L", Material: "EcoSystem fabric" },
  ...
  },
  {
    ...
    stockCount: 14,
    sku: "ACC-APL-WSE",
    features: ["Activity tracking", "Crash & fall detection", "Swim proof (50m)", "All-day battery life"],
    specifications: { Brand: "Apple", Type: "Smartwatch", Display: "OLED Retina", "Water Resistance": "50m" },
  ...
  },
  {
    ...
    description: "Versatile daypack with FlexVent suspension and laptop compartment.",
    ...
    stockCount: 22,
    sku: "ACC-TNF-BOR",
    features: ["FlexVent suspension system", "Laptop compartment", "100% recycled nylon", "Front bungee system"],
    specifications: { Brand: "The North Face", Type: "Daypack", Volume: "28L", Material: "Recycled nylon" },
  ...
  // Collectibles
  {
    ...
    description: "Limited edition KAWS x Medicom collaboration figure. Art meets collectible.",
    ...
    stockCount: 2,
    sku: "COL-BBR-KWS",
    features: ["1000% size (70cm)", "KAWS collaboration", "Limited edition", "Premium vinyl construction"],
    specifications: { Brand: "Medicom Toy x KAWS", Height: "70cm (27.6\")", Material: "Vinyl", Edition: "Limited" },
  ...
  },
  {
    ...
    description: "Gem Mint PSA 10 graded Base Set Charizard. The holy grail of Pokemon cards.",
    ...
    stockCount: 1,
    sku: "COL-PKM-CHR",
    features: ["PSA 10 Gem Mint grade", "Base Set holographic", "Authenticated & encased", "Investment grade"],
    specifications: { Set: "Base Set", Card: "#4/102 Charizard", Grade: "PSA 10 Gem Mint", Year: "1999" },
  ...
  },
  {
    ...
    description: "Ultimate Collector Series Millennium Falcon. 7,541 pieces of pure joy.",
    ...
    stockCount: 3,
    sku: "COL-LGO-MF",
    features: ["7,541 pieces", "1:1 scale replica", "Detailed interior", "7 minifigures included"],
    specifications: { Brand: "LEGO", Theme: "Star Wars UCS", Pieces: "7,541", Dimensions: "33\" x 22\" x 8\"" },
  ...
  },
  {
    ...
    description: "Limited chase variant with metallic finish. A must for Marvel collectors.",
    ...
    stockCount: 9,
    sku: "COL-FNK-SPD",
    features: ["Metallic chase variant", "Exclusive release", "Window display box", "3.75\" vinyl figure"],
    specifications: { Brand: "Funko", Line: "Pop! Marvel", Height: "3.75\"", Material: "Vinyl" },
