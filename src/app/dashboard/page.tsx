          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-sm text-muted">{t('activityAtAGlance')}</p>
              </div>
            </div>
          </div>
              ...
              {recentPurchases.map((purchase, i) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[11px] text-muted mt-0.5">
                      {t('fromSeller', { seller: purchase.sellerName })} ·{' '}
                      {purchase.date}
                    </p>
                  </div>
                  <div className="text-right shrink-0">
                    ...
                    <Badge
                      variant={statusVariant[purchase.status] || 'default'}
                    >
        ...
        {[
          {
            ...
            color: 'text-primary',
            bg: 'bg-primary/[0.06] hover:bg-primary/10 border-primary/10',
          },
          {
            href: '/dashboard/buying',
            icon: ShoppingBag,
            label: t('purchases'),
            color: 'text-blue-400',
            bg: 'bg-blue-400/[0.06] hover:bg-blue-400/10 border-blue-400/10',
          },
          {
            ...
            label: t('portfolio'),
            color: 'text-violet-400',
            bg: 'bg-violet-400/[0.06] hover:bg-violet-400/10 border-violet-400/10',
          },
          {
            ...
            label: t('payouts'),
            color: 'text-emerald-400',
            bg: 'bg-emerald-400/[0.06] hover:bg-emerald-400/10 border-emerald-400/10',
          },
        ].map((action) => (
          <Link
            key={action.href}
          ...
          >
            <div
              className={`w-9 h-9 rounded-lg bg-white/[0.03] flex items-center justify-center ${action.color} group-hover:scale-105 transition-transform`}
            >
              <action.icon size={16} />
            </div>
