              ...
              {filteredPayouts.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-sm text-muted mt-1">
                    {t('payoutHistoryWillAppear')}
                  </p>
                </motion.div>
              ) : (
                filteredPayouts.map((payout, i) => {
                  const feePercent = (
                    (payout.fee / payout.amount) *
                    100
                  ).toFixed(0);
                    ...
                    >
                      ...
                      <div className="text-right relative">
                        <button
                          onClick={() =>
                            setOpenMenu(
                              openMenu === payout.id ? null : payout.id
                            )
                          }
              ...
              <div className="flex items-center gap-4 text-[11px] text-muted">
                <span>
                  ...
                  <span className="font-semibold text-foreground">
                    {formatPrice(
                      filteredPayouts.reduce((sum, p) => sum + p.amount, 0)
                    )}
                  </span>
                </span>
                ...
                <span>
                  ...
                  <span className="font-semibold text-red-400">
                    -
                    {formatPrice(
                      filteredPayouts.reduce((sum, p) => sum + p.fee, 0)
                    )}
                  </span>
                </span>
                <span className="w-px h-3 bg-white/[0.06]" />
                <span>
                  ...
                  <span className="font-semibold text-emerald-400">
                    {formatPrice(
                      filteredPayouts.reduce((sum, p) => sum + p.net, 0)
                    )}
                  </span>
                </span>
              </div>
