            ...
            <div className="h-28 bg-gradient-to-r from-primary/20 via-violet-500/10 to-blue-500/15 relative overflow-hidden">
              {bannerPreview ? (
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      'repeating-linear-gradient(135deg, transparent, transparent 20px, rgba(255,255,255,0.02) 20px, rgba(255,255,255,0.02) 21px)',
                  }}
                />
              )}
              <input
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted mt-1.5 ml-1">
                  vendfinder.com/profile/{username || t('usernameDefault')}
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between mt-1.5 ml-1">
                  ...
                  <p
                    className={`text-[11px] font-medium ${bio.length > 140 ? 'text-amber-400' : 'text-muted'}`}
                  >
                    {bio.length}/160
                  </p>
                </div>
              ...
              {[
                ...
                return (
                  <div key={social.label}>
                    ...
                    <div className="relative">
                      <div
                        className={`absolute left-2 top-1/2 -translate-y-1/2 w-7 h-7 rounded-lg ${social.bgColor} ${social.color} flex items-center justify-center`}
                      >
